...
sys.path.insert(1, '/home/sarvesh/catkin_ws/src/dodo_detector_ros/dodo_detector/dodo_detector')
import detection
from os.path import expanduser
from cv_bridge import CvBridge, CvBridgeError
from sensor_msgs import point_cloud2 as pc2
from sensor_msgs.msg import Image, PointCloud2
from detection import TFObjectDetectorV1, TFObjectDetectorV2, KeypointObjectDetector
      ...
      while not rospy.is_shutdown():
         ...
         if self._current_image is not None:
            try:
               ...
               #print('SHAPE:',scene1.shape)
               #scene = scene1[200:600, 300:1000]
